			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="table-responsive">
						<s:form action="provM/list.action" method="post" id="form-list"
							commandName="prov">
									...
									<tr>
										...
										<!-- <c:if test="${loginU.role eq 1 }">&nbsp;单位类型 <select
												...
												&nbsp;
													...
													<a href="provM/addProv.action"><button type="button"
													...
													<div
														class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="green updateGoods"
																	href="provM/query.action?id=${li.id}"> <i
