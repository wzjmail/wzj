	...
	<div class="content">
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					<!-- PAGE CONTENT BEGINS -->
					<s:form action="provM/update.action" class="form-horizontal"
						method="post" id="form-list" commandName="prov">
						<input type="hidden" name="id" class="id" value="${prov.id}" />
						...
						<div class="row" style="height: 50px;">
							...
							<div style="padding-top: 13px;">
								<input type="text" value="${prov.tel}"
						...
						<!-- <div class="row" style="height: 50px;">
							...
							<div style="padding-top: 13px;">
								<select name="type" class="col-xs-10 col-sm-5 type">
									<option value="1"
										<c:if test="${prov.type eq 1}">selected="selected"</c:if>>好</option>
									<option value="0"
										<c:if test="${prov.type eq 0}">selected="selected"</c:if>> 一般</option>
