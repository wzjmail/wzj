...
<body>
	...
	<script type="text/javascript">
		...
		function init() {
			...
			gradient.addColorStop(0, "#00A7FD");
			gradient.addColorStop(0.6, "#4584b4");
		...
		function onWindowResize(event) {
			...
			camera.aspect = window.innerWidth / window.innerHeight*0.976;
			camera.updateProjectionMatrix();

			renderer.setSize(window.innerWidth, window.innerHeight*0.976);
