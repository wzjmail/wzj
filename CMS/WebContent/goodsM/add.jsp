	...
	<div class="content">
		<div class="page-content">
			<div class="page-header">
				<h1>
					添加 <small> <i class="icon-double-angle-right"></i> 商品信息
					</small>
				</h1>
			</div>
			<!-- /.page-header -->
			...
			<div class="row">
				<div class="col-xs-12">
					<!-- PAGE CONTENT BEGINS -->
					<s:form action="goodsM/add.action" class="form-horizontal"
					...
					-->	
						<div class="row" style="height: 50px;">
							<div class="col-xs-2"></div>
							<div class="col-xs-2" style="padding-top: 13px;">
								<span class="sright"><font size="4">商品名称:</font></span>
							</div>
							<div style="padding-top: 13px;">
						...
						<div class="row" style="height: 50px;">
							...
							<div style="padding-top: 13px;">
								<input onfocus="this.type='text'" placeholder="价格"
									name="price" class=" col-xs-5 price" />
						...
						<div class="row" style="height: 50px;">
							<div class="col-xs-2"></div>
							<div class="col-xs-2" style="padding-top: 13px;">
								<span class="sright"><font size="3">类型:</font></span>
							</div>
							<div style="padding-top: 13px;">
								<select name="type">
									<option value="1">个人护理</option>
									<option value="2">零食/茶酒</option>
									<option value="3">厨具/收纳</option>
						...
						<div class="row" style="height: 50px;">
							...
							<div style="padding-top: 13px;">
								<input onfocus="this.type='text'" placeholder="库存"
